...
Route::get('/quotes/{quote:public_id}', [QuoteController::class, 'show'])->name('quotes.show');
Route::post('/quotes/{quote:public_id}/decision', [QuoteController::class, 'decide'])
    ->middleware('signed')
    ->name('quotes.decide');

// Quote approval follow-up: terms and checkout
Route::get('/quotes/{quote:public_id}/terms', [QuoteController::class, 'terms'])->name('quotes.terms');
Route::post('/quotes/{quote:public_id}/terms', [QuoteController::class, 'acceptTerms'])->name('quotes.terms.accept');
Route::middleware('auth')->group(function () {
    Route::get('/quotes/{quote:public_id}/checkout', [QuoteController::class, 'checkout'])->name('quotes.checkout');
    Route::post('/quotes/{quote:public_id}/checkout', [QuoteController::class, 'placeOrder'])->name('quotes.checkout.place');

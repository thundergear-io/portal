...
<a href="{{ $extension['url'] }}" target="_blank" rel="noopener noreferrer"
    class="flex flex-col overflow-hidden transition-all duration-300 bg-white border border-gray-300 rounded-3xl shadow-sm dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg hover:border-primary-500 dark:hover:border-primary-500">

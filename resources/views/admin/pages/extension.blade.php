        ...
        <div class="">
            <div class="flex flex-col gap-4">
                <div class="relative">
                    ...
                    <input type="search" placeholder="Search extensions by name..." wire:model.live.debounce.500ms="search" class="block w-full p-3 border-gray-300 rounded-3xl shadow-sm ps-10 bg-gray-50 dark:bg-gray-700 dark:border-gray-600 focus:ring-primary-500 focus:border-primary-500">
                </div>
                <div class="flex items-center space-x-2">
                    @php
                        $baseClasses = 'px-4 py-2 text-sm font-medium border rounded-3xl focus:outline-none transition-colors';
            ...
            <div class="mt-6">
                @if($this->error)
                    <div class="p-4 text-center text-gray-500 bg-white border border-gray-300 rounded-3xl shadow-sm dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400">

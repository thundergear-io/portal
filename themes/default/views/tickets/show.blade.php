        ...
        <div class="md:grid grid-cols-4 flex flex-col gap-4">
            <div class="md:col-span-3">
                <div class="flex flex-col gap-4 max-h-[60vh] overflow-y-auto pr-4" wire:poll.10s>
                    ...
                    <div class="bg-base-100 hover:bg-base-100/80 border border-base-300 p-4 rounded-3xl w-full max-w-[80%]  {{ $message->user_id === $ticket->user_id ? 'ml-auto' : 'mr-auto' }}"
                ...
                <div class="mt-4">
                    <form wire:submit.prevent="save">
                        ...
                        <div x-data="{
                            ...
                            <div class="flex justify-center rounded-3xl bg-base-100 border border-dashed border-base-300 px-6 py-2"
                                x-on:dragover.prevent="drop = true" @dragleave="drop = false"
                                @drop.prevent="handleDrop($event)" :class="{'bg-base-100/80': drop}">
                                    <!-- Upload Progress Bar -->
                                <div x-show="uploading" class="w-full text-center">
                                    ...
                                    <div class="w-full bg-primary-600 rounded-3xl h-3 mb-4">
                                        <div class="bg-success h-3 rounded-3xl" :style="{ width: `${progress}%` }"></div>
                                    </div>
                                </div>
                                <template x-if="selectedFiles.length === 0 && !uploading">
                                    <div class="text-center">
                                        <div class="flex text-sm text-primary-100">
                                            ...
                                            <p class="pl-1 text-base-content/80">{{ __('ticket.or_drag_and_drop') }}</p>
                                        </div>
                                        <p class="text-xs/5 text-base-content/50">{{ __('ticket.files_max') }}</p>
                                    </div>
                                </template>

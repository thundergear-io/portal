    ...
    <div class="space-y-4">
        ...
        <div wire:click="$set('selectedMethod', '{{ $agreement->ulid }}')"
            class="flex items-center justify-between p-4 bg-base-100 border rounded-3xl cursor-pointer transition-all
                    {{ $selectedMethod === $agreement->ulid ? 'border-primary ring-2 ring-primary' : 'border-base-300 hover:border-base-300-focus' }}"
            ...
            <div
                class="size-5 rounded-full border border-base-300 flex items-center justify-center
                                    {{ $selectedMethod === $agreement->ulid ? 'border-primary bg-primary' : 'border-base-300-focus' }}">

<div class="container mt-14">
    ...
    <div class="grid grid-cols-3 gap-6 mt-2">
        <div class="grid md:grid-cols-2 gap-6 col-span-2">
            ...
            <div>
                ...
                <label for="product-{{ $service->product->id }}"
                    class="flex flex-col cursor-pointer bg-base-100 hover:bg-base-100/80 border border-base-200 peer-checked:border-secondary p-4 rounded-3xl">
                    <div
            ...
            <div>
                ...
                <label for="product-{{ $product->id }}"
                    class="flex flex-col cursor-pointer bg-base-100 hover:bg-base-100/80 border border-base-300 peer-checked:border-secondary p-4 rounded-3xl">
        ...
        <div class="flex flex-col gap-2 w-full col-span-1 bg-base-100 p-3 rounded-md h-fit">

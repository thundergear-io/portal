    ...
    <div class="px-2">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3 mt-8">
                <div class="bg-base-100 border border-base-300 rounded-3xl overflow-hidden size-9 flex items-center justify-center">
        ...
        <div class="bg-base-100 border border-base-300 p-4 rounded-3xl mb-4 hover:bg-base-100/80 transition-colors">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <div class="rounded-3xl overflow-hidden flex items-center justify-center">
        ...
        @endforeach
        @else
        <div class="bg-base-100 border border-base-300 p-6 rounded-3xl text-center">
        ...
        <a href="{{ route('invoices.show', $transaction->invoice) }}" wire:navigate>
            <div
                class="bg-base-100 hover:bg-base-100/80 border border-base-300 p-1 rounded-3xl mb-4">
                <div class="flex items-center justify-between">

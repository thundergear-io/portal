<div class="container mt-20">
    ...
    <div class="px-2">
        ...
        <div class="bg-base-100 rounded-3xl p-4 mb-6" x-data="pushNotifications">
        ...
        <div class="overflow-x-auto">
            <table class="w-full bg-base-100 rounded-3xl">
                <thead>
                    <tr class="border-b border-base-300/20">
                ...
                <tbody x-data="{ preferences: $wire.entangle('preferences') }">
                    ...
                    <tr class="border-b border-base-300 hover:bg-base-100/80 transition-colors">
                        <td class="py-4 px-6 text-base-content/70">
                            {{ $notification->name }}
                        </td>
                        <td class="py-4 px-4">

<div
    class="mx-auto flex flex-col gap-2 mt-4 px-6 sm:px-14 py-10 bg-base-100 rounded-md xl:max-w-[60%] w-full">
    ...
    <form class="flex flex-col gap-2 mt-4" wire:submit.prevent="submit" id="verify-email">
        ...
        <p class="text-base-content">{{ __('auth.verification.not_received') }}</p>

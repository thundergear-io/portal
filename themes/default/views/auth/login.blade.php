<form
    ...
    <div class="flex flex-col items-center mt-4">
        ...
        <div class="flex flex-row flex-wrap justify-center mt-2 gap-4">
            ...
            <a href="{{ route('oauth.redirect', $provider) }}"
                class="flex items-center justify-center px-4 h-10 border border-base-300 rounded-md text-primary">
    ...
    <div class="text-base-content text-center rounded-md py-2 mt-6 text-sm">
        {{ __('auth.dont_have_account') }}
        <a class="text-sm text-secondary hover:underline" href="{{ route('register') }}"
            wire:navigate>
            {{ __('auth.sign_up') }}
        </a>
    </div>

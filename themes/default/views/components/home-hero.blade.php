<div class="grow flex flex-col lg:flex-row relative">
    <button class="btn btn-circle btn-ghost absolute top-4 right-4 z-50" @click="darkMode = !darkMode">
        ...
        <svg x-show="!darkMode" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-base-content" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" /></svg>
    </button>

        <!-- Left side -->
        <div class="relative w-full lg:w-1/2 lg:fixed lg:inset-0 lg:overflow-y-auto bg-base-200 lg:rounded-r-3xl">
            ...
            <div class="min-h-full w-full max-w-xl mx-auto flex flex-col justify-start px-4 sm:px-6 pt-36 pb-20 lg:py-20">
                <div class="grow flex flex-col justify-center">
                    ...
                    <div class="space-y-3">
                        ...
                        <h1 class="text-2xl font-bold text-base-content">The Company Corp.</h1>
                        <time class="block text-xl text-base-content/60">20 April, 2024</time>
                    </div>
        ...
        <!-- Right side -->
        <main class="max-lg:grow flex flex-col w-full lg:w-1/2 lg:ml-auto bg-base-100 text-base-content">
            <!-- Page content -->
            <div class="grow w-full max-w-xl mx-auto px-4 sm:px-6 py-12 lg:pt-24 lg:pb-20">

                <article class="divide-y divide-base-300 -mt-8 mb-4">
                    <section class="py-8">
                        <h3 class="text-lg font-bold mb-2">Brief</h3>
                        <div class="text-base-content/70 space-y-4">
                            The client is looking to review and revamp the information architecture, user experience and user interface design of <strong class="text-base-content font-medium">The Company Corp.</strong>, a web application that connects landlords and tenants across Europe and America.
                        </div>
                    </section>
                        ...
                        <ul class="grid gap-4 sm:grid-cols-3 text-sm">
                            <div class="card bg-base-100 shadow-sm border border-base-200">
                                <div class="card-body p-4">
                                    <h4 class="card-title text-sm text-base-content/70 font-medium">Project Length</h4>
                                    <div class="text-base-content">4-8 Weeks</div>
                                </div>
                            </div>
                            <div class="card bg-base-100 shadow-sm border border-base-200">
                                <div class="card-body p-4">
                                    <h4 class="card-title text-sm text-base-content/70 font-medium">Start Date</h4>
                                    <time class="text-base-content">27 Jun, 2024</time>
                                </div>
                            </div>
                            <div class="card bg-base-100 shadow-sm border border-base-200">
                                <div class="card-body p-4">
                                    <h4 class="card-title text-sm text-base-content/70 font-medium">End Date</h4>
                                    <time class="text-base-content">27 Aug, 2024</time>
                                </div>
                            </div>
                        </ul>
                    </section>
                                ...
                                <tbody>
                                    <tr class="border-b border-base-200">
                                        <td class="px-4 py-5">
                                            ...
                                            <p class="text-base-content/70">The client is looking to review the information.</p>
                                        </td>
                                ...
                                <tfoot>
                                    <tr class="border-t border-base-200">
                                        <th scope="row" class="px-4 py-5 text-left font-normal">
                                            <p class="text-base-content/70 italic">Total in USD dollar</p>
                                        </th>
                                        <td class="px-4 py-5 text-right font-semibold text-success">$24,560</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
            ...
            <!-- Call to action -->
            <div class="fixed bottom-0 z-30 w-full lg:w-1/2 bg-base-100/80 backdrop-blur border-t border-base-200">
                <div class="w-full max-w-xl mx-auto px-4 sm:px-6">
                    <div class="flex py-4 md:py-6 gap-4">
                        ...
                        <a href="#" class="btn btn-primary flex-1">Pay - $24,560</a>
                    </div>
                </div>
            </div>
        </main>

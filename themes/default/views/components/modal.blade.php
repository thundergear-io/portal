...
<div x-data="{ open: {{ $open ? 'true' : 'false' }} }">
    <template x-teleport="body">
        <div class="fixed inset-0 z-30 flex items-center justify-center overflow-hidden bg-black/50"
            x-show="open">
            <!-- Modal inner -->
            <div class="px-6 py-4 w-full mx-2 md:mx-auto text-left bg-base-100 rounded shadow-lg max-h-[calc(100%-theme('spacing.8'))] overflow-y-auto mb-8 mt-8 {{ $width }}" x-cloak

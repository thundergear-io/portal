            ...
            <div class="flex flex-row items-center">
                ...
                <div class="md:flex hidden flex-row ml-6">
                        ...
                        <x-dropdown>
                            <x-slot:trigger>
                                <div class="flex flex-col">
                                    <span class="flex flex-row items-center p-3 text-base whitespace-nowrap text-base-content hover:text-base-content/80">
                                        {{ $nav['name'] }}
                                    </span>
                                </div>
                            </x-slot:trigger>
                    ...
                    <x-navigation.link
                        ...
                        class="flex items-center p-3 text-base">
                        {{ $nav['name'] }}
                    </x-navigation.link>
                    @endif
                    {{-- @if($nav['separator'])
            ...
            <div class="flex flex-row items-center">
                ...
                <div class="items-center hidden md:flex mr-1">
                    <x-dropdown>
                        <x-slot:trigger>
                            <div class="flex flex-col">
                                <span class="text-base text-base-content text-nowrap">{{ strtoupper(app()->getLocale()) }} <span class="text-base-content/50">|</span> {{ \App\Models\Currency::find(session('currency', config('settings.default_currency')))?->name ?? session('currency', config('settings.default_currency')) }}</span>
                            </div>
                        </x-slot:trigger>
                        <x-slot:content>
                            <strong class="block p-2 text-sm text-base-content/50"> Language </strong>
                ...
                <div class="hidden lg:flex">
                    <x-dropdown :showArrow="false">
                        <x-slot:trigger>
                            <img src="{{ auth()->user()->avatar }}" class="size-8 rounded-full border border-base-300 bg-background" alt="avatar" />
                        </x-slot:trigger>
                        <x-slot:content>
                ...
                <button
                    ...
                    class="relative w-10 h-10 flex lg:hidden items-center justify-center rounded-3xl hover:bg-neutral transition"
        ...
        <template x-teleport="body">
            <div
                ...
                <div
                    ...
                    class="absolute inset-0 bg-base-100 border-t border-base-300 shadow-lg overflow-y-auto flex flex-col">
                        ...
                        <div class="mt-5">
                            ...
                            <div
                                ...
                                <button @click="userPanelOpen = true" aria-label="Open user menu" class="flex gap-4 items-center justify-start">
                                    <img src="{{ auth()->user()->avatar }}" class="size-10 rounded-full border border-base-300 bg-background" alt="avatar" />
                                ...
                                <div
                                    ...
                                    tabindex="-1"
                                    aria-modal="true">
                                    <div class="bg-base-100 shadow-lg rounded-t-2xl border border-base-300 p-6">
                                        <div class="flex gap-4 items-center justify-start">
                                            <img src="{{ auth()->user()->avatar }}" class="size-12 rounded-full border border-base-300 bg-background" alt="avatar" />

    ...
    <el-popover-group class="hidden lg:flex lg:gap-x-12">
      <div class="relative">
        ...
        <el-popover id="desktop-menu-product" anchor="bottom" popover class="w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg outline-1 outline-gray-900/5 transition transition-discrete [--anchor-gap:--spacing(3)] backdrop:bg-transparent open:block data-closed:translate-y-1 data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in dark:bg-gray-800 dark:shadow-none dark:-outline-offset-1 dark:outline-white/10">
          <div class="p-4">
            <div class="group relative flex items-center gap-x-6 rounded-3xl p-4 text-sm/6 hover:bg-gray-50 dark:hover:bg-white/5">
              <div class="flex size-11 flex-none items-center justify-center rounded-3xl bg-gray-50 group-hover:bg-white dark:bg-gray-700/50 dark:group-hover:bg-gray-700">
      ...
      <div class="relative">
        ...
        <el-popover id="desktop-menu-company" anchor="bottom" popover class="w-96 overflow-visible rounded-3xl bg-white p-4 shadow-lg outline-1 outline-gray-900/5 transition transition-discrete [--anchor-gap:--spacing(3)] backdrop:bg-transparent open:block data-closed:translate-y-1 data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in dark:bg-gray-800 dark:-outline-offset-1 dark:outline-white/10">
          <div class="relative rounded-3xl p-4 hover:bg-gray-50 dark:hover:bg-white/5">
      ...
      <div tabindex="0" class="fixed inset-0 focus:outline-none">
        <el-dialog-panel class="fixed inset-y-0 right-0 z-10 flex w-full flex-col justify-between overflow-y-auto bg-white sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 dark:bg-gray-900 dark:sm:ring-white/10">
            ...
            <div class="mt-6 flow-root">
              <div class="-my-6 divide-y divide-gray-500/10 dark:divide-white/10">
                <div class="space-y-2 py-6">
                  <a href="#" class="group -mx-3 flex items-center gap-x-6 rounded-3xl p-3 text-base/7 font-semibold hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">Analytics</a>
                  <a href="#" class="group -mx-3 flex items-center gap-x-6 rounded-3xl p-3 text-base/7 font-semibold hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">Engagement</a>
                  <a href="#" class="group -mx-3 flex items-center gap-x-6 rounded-3xl p-3 text-base/7 font-semibold hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">Security</a>
                  <a href="#" class="group -mx-3 flex items-center gap-x-6 rounded-3xl p-3 text-base/7 font-semibold hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">Integrations</a>
                  <a href="#" class="group -mx-3 flex items-center gap-x-6 rounded-3xl p-3 text-base/7 font-semibold hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">Automations</a>
                </div>
                <div class="space-y-2 py-6">
                  <a href="#" class="-mx-3 block rounded-3xl px-3 py-2 text-base/7 font-semibold hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">Features</a>
                  <a href="#" class="-mx-3 block rounded-3xl px-3 py-2 text-base/7 font-semibold hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">Marketplace</a>
                  <a href="#" class="-mx-3 block rounded-3xl px-3 py-2 text-base/7 font-semibold hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">About us</a>
                  <a href="#" class="-mx-3 block rounded-3xl px-3 py-2 text-base/7 font-semibold hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">Careers</a>
                  <a href="#" class="-mx-3 block rounded-3xl px-3 py-2 text-base/7 font-semibold hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">Support</a>
                  <a href="#" class="-mx-3 block rounded-3xl px-3 py-2 text-base/7 font-semibold hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">Blog</a>
                </div>
                <div class="py-6">
                  <a href="#" class="-mx-3 block rounded-3xl px-3 py-2.5 text-base/7 font-semibold hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">Log in</a>
                </div>
              </div>
            </div>
          </div>
          <div class="sticky bottom-0 grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50 text-center dark:divide-white/5 dark:bg-gray-800/50">
            <a href="#" class="p-3 text-base/7 font-semibold hover:bg-gray-100 dark:text-white dark:hover:bg-gray-800">Watch demo</a>
            <a href="#" class="p-3 text-base/7 font-semibold hover:bg-gray-100 dark:text-white dark:hover:bg-gray-800">Contact sales</a>
          </div>
        </el-dialog-panel>
      </div>
    </dialog>

...
export function initBeams(containerId, options = {}) {
  ...
  const beamMaterial = extendMaterial(THREE.MeshStandardMaterial, {
    ...
    material: { fog: true },
    uniforms: {
      diffuse: new THREE.Color(...hexToNormalizedRGB('#020712')),
      time: { value: 0 },
      roughness: 0.3,
      metalness: 0.3,
      uSpeed: { value: speed },
...
document.addEventListener('DOMContentLoaded', () => {
  if (document.getElementById('beams-container')) {
    initBeams('beams-container', {
      rotation: -45,
      beamNumber: 15,
      beamWidth: 3,
      speed: 1.5
